...
public class UserRepositoryImpl extends RepositoryImpl<User, UserRecord> implements UserRepository {
    ...
    public RequirementContributors findRequirementContributors(int requirementId) throws BazaarException {
        ...
        try {
            de.rwth.dbis.acis.bazaar.service.dal.jooq.tables.User creator = USER.as("creator");
            de.rwth.dbis.acis.bazaar.service.dal.jooq.tables.User leadDeveloper = USER.as("leadDeveloper");
            de.rwth.dbis.acis.bazaar.service.dal.jooq.tables.User developer = USER.as("developer");
            de.rwth.dbis.acis.bazaar.service.dal.jooq.tables.User commentCreator = USER.as("commentCreator");
            de.rwth.dbis.acis.bazaar.service.dal.jooq.tables.User attachmentCreator = USER.as("attachmentCreator");
    ...
    public CategoryContributors findCategoryContributors(int categoryId) throws BazaarException {
        ...
        try {
            de.rwth.dbis.acis.bazaar.service.dal.jooq.tables.User leader = USER.as("leader");
            de.rwth.dbis.acis.bazaar.service.dal.jooq.tables.User requirementCreator = USER.as("requirementCreator");
            de.rwth.dbis.acis.bazaar.service.dal.jooq.tables.User leadDeveloper = USER.as("leadDeveloper");
            de.rwth.dbis.acis.bazaar.service.dal.jooq.tables.User developer = USER.as("developer");
            de.rwth.dbis.acis.bazaar.service.dal.jooq.tables.User commentCreator = USER.as("commentCreator");
            de.rwth.dbis.acis.bazaar.service.dal.jooq.tables.User attachmentCreator = USER.as("attachmentCreator");
    ...
    public ProjectContributors findProjectContributors(int projectId) throws BazaarException {
        ...
        try {
            de.rwth.dbis.acis.bazaar.service.dal.jooq.tables.User leader = USER.as("leader");
            de.rwth.dbis.acis.bazaar.service.dal.jooq.tables.User categoryLeader = USER.as("categoryLeader");
            de.rwth.dbis.acis.bazaar.service.dal.jooq.tables.User requirementCreator = USER.as("requirementCreator");
            de.rwth.dbis.acis.bazaar.service.dal.jooq.tables.User leadDeveloper = USER.as("leadDeveloper");
            de.rwth.dbis.acis.bazaar.service.dal.jooq.tables.User developer = USER.as("developer");
            de.rwth.dbis.acis.bazaar.service.dal.jooq.tables.User commentCreator = USER.as("commentCreator");

 ...
 * @since 6/23/2014
 */
public class RequirementDeveloperTransformator implements Transformator<RequirementDeveloper, de.rwth.dbis.acis.bazaar.service.dal.jooq.tables.records.RequirementDeveloperMapRecord> {
    @Override

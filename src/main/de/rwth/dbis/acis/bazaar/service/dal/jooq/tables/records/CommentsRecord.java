...
public class CommentsRecord extends UpdatableRecordImpl<CommentsRecord> implements Record7<Integer, String, Timestamp, Timestamp, Integer, Integer, Integer> {

    private static final long serialVersionUID = -211949362;
    ...
    /**
     * Setter for <code>reqbaz.comments.BelongsToComment_Id</code>.
     */
    public void setBelongstocommentId(Integer value) {
        set(6, value);
    }

    /**
     * Getter for <code>reqbaz.comments.BelongsToComment_Id</code>.
     */
    public Integer getBelongstocommentId() {
    ...
    public Field<Integer> field7() {
        return Comments.COMMENTS.BELONGSTOCOMMENT_ID;
    }
     ...
     */
    @Override
    public CommentsRecord values(Integer value1, String value2, Timestamp value3, Timestamp value4, Integer value5, Integer value6, Integer value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CommentsRecord(Integer id, String message, Timestamp creationTime, Timestamp lastupdatedTime, Integer requirementId, Integer userId, Integer belongstocommentId) {
        super(Comments.COMMENTS);

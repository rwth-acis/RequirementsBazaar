...
public class AttachmentsRecord extends UpdatableRecordImpl<AttachmentsRecord> implements Record8<Integer, Timestamp, Timestamp, Integer, Integer, String, String, String> {

	private static final long serialVersionUID = 480099699;
	 ...
	 */
	@Override
	public Row8<Integer, Timestamp, Timestamp, Integer, Integer, String, String, String> fieldsRow() {
	 ...
	 */
	@Override
	public Row8<Integer, Timestamp, Timestamp, Integer, Integer, String, String, String> valuesRow() {
	 ...
	 */
	@Override
	public AttachmentsRecord values(Integer value1, Timestamp value2, Timestamp value3, Integer value4, Integer value5, String value6, String value7, String value8) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public AttachmentsRecord(Integer id, Timestamp creationTime, Timestamp lastupdatedTime, Integer requirementId, Integer userId, String title, String description, String mimeType) {
		super(Attachments.ATTACHMENTS);

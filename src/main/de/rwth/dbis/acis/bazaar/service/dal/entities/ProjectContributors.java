...
public class ProjectContributors extends EntityBase {
    ...
    protected ProjectContributors(Builder builder) {
        this.id = builder.id;
        this.leader = builder.leader;
        this.categoryLeader = builder.categoryLeader;
    ...
    public List<User> getCategoryLeader() {
    ...
    public static class Builder {
        ...
        public Builder categoryLeader(List<User> categoryLeader) {

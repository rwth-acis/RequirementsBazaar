...
public class User extends TableImpl<UserRecord> {
    ...
    private static final long serialVersionUID = 1439298886;
     ...
     */
    public final TableField<UserRecord, Boolean> ADMIN = createField("admin", org.jooq.impl.SQLDataType.BOOLEAN.nullable(false), this, "");

    /**
     * The column <code>reqbaz.user.las2peer_id</code>.
     */
    public final TableField<UserRecord, String> LAS2PEER_ID = createField("las2peer_id", org.jooq.impl.SQLDataType.VARCHAR.length(128), this, "");
    ...
    public List<UniqueKey<UserRecord>> getKeys() {
        return Arrays.<UniqueKey<UserRecord>>asList(Keys.KEY_USER_PRIMARY, Keys.KEY_USER_LAS2PEER_IDX);
    }

...
public class Requirements extends TableImpl<RequirementsRecord> {
    ...
    private static final long serialVersionUID = 822343303;
     ...
     */
    public final TableField<RequirementsRecord, Timestamp> CREATION_TIME = createField("creation_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

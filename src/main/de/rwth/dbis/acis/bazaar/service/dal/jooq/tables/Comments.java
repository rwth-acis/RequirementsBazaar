...
public class Comments extends TableImpl<CommentsRecord> {
	 ...
	 */
	public final TableField<CommentsRecord, Timestamp> CREATION_TIME = createField("creation_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaulted(true), this, "");

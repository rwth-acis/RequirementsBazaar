 ...
 * @since 3/4/2015
 */
public class RecentDevelopersMetric extends SinceMetricBase{
    public RecentDevelopersMetric(Duration duration) {
        super(duration);
    }
    ...
    public Field<Integer> getRequirementIdField() {
        return DEVELOPERS.REQUIREMENT_ID;
    }

    @Override
    public Field<Timestamp> getCreationTimeField() {
        return DEVELOPERS.CREATION_TIME;
    }
}

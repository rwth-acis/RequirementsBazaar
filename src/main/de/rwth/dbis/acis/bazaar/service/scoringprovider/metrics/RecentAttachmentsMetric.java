 ...
 * @since 3/4/2015
 */
public class RecentAttachmentsMetric extends SinceMetricBase {
    public RecentAttachmentsMetric(Duration duration) {
        super(duration);
    }
    ...
    public Field<Integer> getRequirementIdField() {
        return ATTACHMENTS.REQUIREMENT_ID;
    }

    @Override
    public Field<Timestamp> getCreationTimeField() {
        return ATTACHMENTS.CREATION_TIME;
    }

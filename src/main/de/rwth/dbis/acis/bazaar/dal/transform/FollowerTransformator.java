 ...
 * @since 6/23/2014
 */
public class FollowerTransformator implements Transformator<de.rwth.dbis.acis.bazaar.dal.entities.Follower,de.rwth.dbis.acis.bazaar.dal.jooq.tables.records.FollowersRecord> {
    @Override

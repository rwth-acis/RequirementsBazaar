 ...
 * @since 6/22/2014
 */
public class AttachmentTransformator implements Transformator<de.rwth.dbis.acis.bazaar.dal.entities.Attachment,de.rwth.dbis.acis.bazaar.dal.jooq.tables.records.AttachementsRecord> {

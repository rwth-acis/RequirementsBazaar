 ...
 * @since 6/23/2014
 */
public class AuthorizationTransformator implements Transformator<de.rwth.dbis.acis.bazaar.dal.entities.Authorization,de.rwth.dbis.acis.bazaar.dal.jooq.tables.records.AuthorizationsRecord> {
    @Override

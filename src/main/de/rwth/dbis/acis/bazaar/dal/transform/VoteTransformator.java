 ...
 * @since 6/23/2014
 */
public class VoteTransformator implements de.rwth.dbis.acis.bazaar.dal.transform.Transformator<de.rwth.dbis.acis.bazaar.dal.entities.Vote,de.rwth.dbis.acis.bazaar.dal.jooq.tables.records.VotesRecord> {
    @Override
    ...
    @Override
    public Vote mapToEntity(VotesRecord record) {

 ...
 * @since 6/23/2014
 */
public class DeveloperTransformator implements Transformator<de.rwth.dbis.acis.bazaar.dal.entities.Developer, de.rwth.dbis.acis.bazaar.dal.jooq.tables.records.DevelopersRecord> {
    @Override

...
public class ProjectsResource {
    ...
    public Response getRequirementsForProject(@PathParam("projectId") int projectId,
                                              ...
                                              @ApiParam(value = "Sort", required = false, allowMultiple = true, allowableValues = "date,last_activity,name,vote,comment,follower,realized") @DefaultValue("date") @QueryParam("sort") List<String> sort,
                                              @ApiParam(value = "SortDirection", allowableValues = "ASC,DESC") @QueryParam("sortDirection") String sortDirection
    ) throws Exception {

 ...
 * @since 6/22/2014
 */
public interface RequirementDeveloperRepository extends Repository<RequirementDeveloper> {
    ...
    CreationStatus addOrUpdate(RequirementDeveloper developer) throws BazaarException;
}

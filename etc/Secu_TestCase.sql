...
CREATE TABLE IF NOT EXISTS `attachments` (
  ...
  `discriminator` char(1) COLLATE utf8_bin NOT NULL,
  ...
  `object_desc` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`Id`),
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=902 ;
...
CREATE TABLE IF NOT EXISTS `projects` (
  ...
  `name` varchar(255) COLLATE utf8_bin NOT NULL,
  `description` text COLLATE utf8_bin NOT NULL,
  `visibility` char(1) COLLATE utf8_bin NOT NULL,
  `Leader_Id` int(11) NOT NULL,
...
INSERT INTO `requirements` (`Id`, `title`, `description`, `creation_time`, `Lead_developer_Id`, `Creator_Id`, `Project_Id`) VALUES
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `profile_image` text COLLATE utf8_bin,
  PRIMARY KEY (`Id`)
...
INSERT INTO `users` (`Id`, `first_name`, `last_name`, `email`, `admin`, `Las2peer_Id`, `user_name`, `profile_image`) VALUES
(41, NULL, NULL, 'anonymous@requirements-bazaar.org', 0, -1722613621014065292, 'anonymous', 'https://api.learning-layers.eu/profile.png'),
(42, NULL, NULL, 'no.email@warning.com', 0, -5021131362343084485, 'adam', 'https://api.learning-layers.eu/profile.png'),
(43, NULL, NULL, 'no.email@warning.com', 0, -7678677630072537742, 'abel', 'https://api.learning-layers.eu/profile.png'),
(44, NULL, NULL, 'no.email@warning.com', 0, -8626247308297765772, 'eve1st', 'https://api.learning-layers.eu/profile.png');
...
CREATE TABLE IF NOT EXISTS `user_role` (
  ...
  `context_info` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`Id`),
